...
object DomainModule {
    ...
    @Provides
    @Singleton
    fun provideVoiceRecognitionService(@ApplicationContext context: Context) = AndroidVoiceRecognitionService(context) as VoiceRecognitionService

    @Provides
    @Singleton
    fun provideSoundPlayerService(@ApplicationContext context: Context) = AndroidSoundPlayer(context) as SoundPlayer
